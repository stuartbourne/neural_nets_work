...
namespace sb_nn{
    ...
    class NeuralNet{
        public:
            ...
            const bool set_feature_num(const int feat_num) { 
                                            num_features_ = feat_num;
                                            return true;
                                            }; 
            const bool set_hidden_neuron_num(const int neuron_num) {
                                            num_hidden_neurons_ = neuron_num;
                                            return true;
                                            };
        ...
        private:
            int num_features_;
            int num_hidden_neurons_;    //can deduce the number of connections by feature_num * hidden_neuron_num
    ...
    template <typename I, typename O>
    const bool NeuralNet<I, O>::train(){
    ...
    template <typename I, typename O>
    const double NeuralNet<I, O>::backpropagate(O desired_output, double activation_out){
        /*
